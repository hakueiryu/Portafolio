...
$sql4="select * from proyecto_planagua where municipio like 'Capacho Nuevo' order by nro asc;";
...
$sql5="select * from proyecto_planagua where municipio like 'Capacho Viejo' order by nro asc;";
...
$sql6="select * from proyecto_planagua where municipio like 'Cárdenas' order by nro asc;";
...
$sql7="select * from proyecto_planagua where municipio like 'Córdoba' order by nro asc;";
...
$sql8="select * from proyecto_planagua where municipio like 'Fernández Feo' order by nro asc;";
...
$sql9="select * from proyecto_planagua where municipio like 'Francisco de Miranda' order by nro asc;";
...
$sql10="select * from proyecto_planagua where municipio like 'García de Hevia' order by nro asc;";
...
$sql11="select * from proyecto_planagua where municipio like 'Guásimos' order by nro asc;";
...
$sql12="select * from proyecto_planagua where municipio like 'Jáuregui' order by nro asc;";
...
$sql13="select * from proyecto_planagua where municipio like 'José María Vargas' order by nro asc;";
...
$sql14="select * from proyecto_planagua where municipio like 'Junín' order by nro asc;";
