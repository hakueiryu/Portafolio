...
<?php 
	...
	$consulta = "SELECT * FROM proyecto_gobernacion WHERE codigo LIKE '%".$id."%'";
...
<table align="center" style="border:1px black solid; border-radius:5px; min-width:150px; text-align: center;">
					...
					<tr>
						...
						<td  width='80px' height='40px' style="text-align: center; background: #ADD8E6;"><?php echo str_replace($search, '<strong>'.$search.'</strong>', $fila['inspeccion']) ?></td>
					</tr>
					<tr>
		...
		<div class="footer center">
			<a href="../../../php/ficha_proyecto_gobernacion.php?cod=<?php echo $fila['codigo'] ?>&search=<?php echo $search ?>"><input type="button" name="ficha" value="Ficha del Proyecto"></a>
		</div>
	</div>
</body>
</html>