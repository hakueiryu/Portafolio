...
<?php 
	...
	$consulta = "SELECT * FROM proyecto_espeaten WHERE codigo LIKE '%".$id."%'";
...
<table align="center" style="border:1px black solid; border-radius:5px; min-width:150px; text-align: center;">
		...
		<div class="footer center">
			<a href="../../../php/ficha_proyecto_espeaten.php?cod=<?php echo $fila['codigo'] ?>&search=<?php echo $search ?>"><input type="button" name="ficha" value="Ficha del Proyecto"></a>
		</div>
	</div>
</body>
</html>