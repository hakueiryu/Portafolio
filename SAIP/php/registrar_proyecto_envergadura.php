...
<body>
<div>
    <form method="post" action="guardar_proyecto_envergadura.php">
...
<tr>
            ...
            <select name="anioi">               <option value="0000">Año</option>
        ...
        <tr>
            ...
            <td colspan="2"><select name="diac">            <option value="0">Dia</option>
                ...
                <select name="anioc">           <option value="0000">Año</option>
                                                <option value="2013">2013</option>
                                                <option value="2014">2014</option>
                                                <option value="2015">2015</option>
                                                <option value="2016">2016</option>
            ...
            <td><input name="ente" type="text" maxlength="100" placeholder="Gobernación, Alcaldia, Ministerio" required autofocus size="30"></td>

            <td><label for="fecha">Año de Aprobación:</label></td>
            <td><select name="anio">                    <option value="0000">Año</option>
                                                        <option value="2013">2013</option>
                                                        <option value="2014">2014</option>
                                                        <option value="2015">2015</option>
                                                        <option value="2016">2016</option>
        ...
        <tr>
            ...
            <td><input type="radio" name="valla" value="Sí">Sí
    ...
    <fieldset>
        <legend>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td width="118" style="text-align: center;"><label for="avance"> Avance Fisíco:</label></td>
                            <td width="222"><input name="avance" type="text" size="1" maxlength="5" placeholder="00000">%</td>
                        </tr>
                        <tr>
                            <td width="114"><label for="estatus">Estatus:</label></td> <td width="226"><select name="estatus" onchange="mostrar(this)" required autofocus>  <option value="">--Seleccione--</option>
            ...
            <select name="anioins">             <option value="0000">Año</option>
                                                <option value="2013">2013</option>
                                                <option value="2014">2014</option>
                                                <option value="2015">2015</option>
                                                <option value="2016">2016</option>
        ...
        <input name="t_ejecucion" type="text" placeholder="Trabajos en ejecución" size="30" maxlength="500">
                ...
                <b>Datos del Entrevistado.</b>
                    ...
                    <table>
                        <tbody>
                                ...
                                <td><input name="entrevistado" type="text" maxlength="50" placeholder="Sarah Connor" size="30"></td>
