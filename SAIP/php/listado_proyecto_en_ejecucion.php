...
<?php
		...
		$sql="SELECT nro,codigo,nombre,municipio,parroquia,avance FROM proyecto_cgec WHERE estatus =  'En Ejecucion' UNION ALL SELECT nro,codigo,nombre,municipio,parroquia,avance FROM proyecto_planagua WHERE estatus =  'En Ejecucion' UNION ALL SELECT nro,codigo,nombre,municipio,parroquia,avance FROM proyecto_envergadura WHERE estatus =  'En Ejecucion' UNION ALL SELECT nro,codigo,nombre,municipio,parroquia,avance FROM proyecto_espeaten WHERE estatus =  'En Ejecucion' UNION ALL SELECT nro,codigo,nombre,municipio,parroquia,avance FROM proyecto_gobernacion WHERE estatus =  'En Ejecucion' UNION ALL SELECT nro,codigo,nombre,municipio,parroquia,avance FROM proyecto_inversion WHERE estatus =  'En Ejecucion' UNION ALL SELECT nro,codigo,nombre,municipio,parroquia,avance FROM proyecto_ministerio WHERE estatus =  'En Ejecucion'";

		$sql100="SELECT SUM(total) SumaTotal
                            FROM (SELECT COUNT(*) total FROM proyecto_inversion WHERE estatus = 'En Ejecucion'
                            UNION ALL
                            SELECT COUNT(*) total FROM proyecto_cgec WHERE estatus = 'En Ejecucion'
                            UNION ALL
                            SELECT COUNT(*) total FROM proyecto_planagua WHERE estatus = 'En Ejecucion'
                            UNION ALL
                            SELECT COUNT(*) total FROM proyecto_espeaten WHERE estatus = 'En Ejecucion'
                            UNION ALL
                            SELECT COUNT(*) total FROM proyecto_gobernacion WHERE estatus = 'En Ejecucion'
                            UNION ALL
                            SELECT COUNT(*) total FROM proyecto_ministerio WHERE estatus = 'En Ejecucion'
                            UNION ALL
                            SELECT COUNT(*) total FROM proyecto_envergadura WHERE estatus = 'En Ejecucion'
                            ) t1";
...
<?php
	...
	//La funcion de javascrip va afuera ya que existe algun conflicto con el echo o el php.
		echo "
				...
				<h2 align='center'>Proyectos En Ejecución.</h2>
					<tr>
						<th scope='col'>Nro</th>
	...
	<br>
	<br>
<center><a href="../reportes/listado_total_en_ejecucion.php" target="_blank"><img src="../iconos/imprimir.png"></a></center>
</body>
</html>
<?php
 } else {
