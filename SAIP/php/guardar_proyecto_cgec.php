<?php
	...
	$nuevo_VAR_CODIGO = mysql_query("select codigo from proyecto_cgec where codigo = '$codigo'");
	...
	echo "<script language='JavaScript'> alert(\"$salida\"); document.location.href='registrar_proyecto_cgec.php';</script>";
?>