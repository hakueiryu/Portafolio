...
<?php
		...
		$sql10="select * from proyecto_inversion where municipio like 'Capacho Nuevo' order by nro asc;";
		...
		$sql14="select * from proyecto_inversion where municipio like 'Capacho Viejo' order by nro asc;";
		...
		$sql100="select count(*) from proyecto_inversion";
		...
		echo "
				...
				<h2 align='center'>Municipio Andrés Bello.</h2>
					...
					echo "<tr>
						...
						<td align='center'><a href='ficha_proyecto_inversion.php?cod=$registro[codigo]' style='text-decoration:none; color:#E43F3F;'>$registro[codigo]</a></td>
						...
						<td align='center'><a href='auditoria_inversion.php?cod=$registro[codigo]' style='text-decoration:none; color:#E43F3F;'>$registro[inspeccion]</a></td>
...
<center><a href="../reportes/listado_total.php" target="_blank"><img src="../iconos/imprimir.png"></a></center>
</body>
</html>
<?php
 } else {
