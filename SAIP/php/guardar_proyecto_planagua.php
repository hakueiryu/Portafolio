<?php
	...
	$nuevo_VAR_CODIGO = mysql_query("select codigo from proyecto_planagua where codigo = '$codigo'");
	...
	echo "<script language='JavaScript'> alert(\"$salida\"); document.location.href='registrar_proyecto_planagua.php';</script>";
?>