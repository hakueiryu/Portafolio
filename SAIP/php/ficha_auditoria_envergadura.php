...
$objPDF=new HTML2PDF("P","Letter","es",true,'UTF-8');
	...
	$sql="select * from proyecto_envergadura where inspeccion>'$numero' and nombre ='$nombre' and codigo ='$codigo'";
	$sql1="select * from auditoria_envergadura where inspeccion='$numero' and nombre ='$nombre' and fk_codigo ='$codigo' and diains ='$dia' and mesins ='$mes' and anioins ='$anio'";
